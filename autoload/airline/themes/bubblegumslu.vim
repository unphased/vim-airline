...
let g:airline#themes#bubblegumslu#palette = {}

" Normal mode
let s:N1 = [s:gui_dark_gray, s:gui_green, s:cterm_dark_gray, s:cterm_green]
let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_light_gray, s:cterm_med_gray_lo]
let s:N3 = [s:gui_green, s:gui_med_gray_hi, s:cterm_green, s:cterm_darker_gray]
let g:airline#themes#bubblegumslu#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#bubblegumslu#palette.normal_modified = {
...
let g:airline#themes#bubblegumslu#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
let g:airline#themes#bubblegumslu#palette.insert_modified = {
      \ 'airline_c': [s:gui_dark_gray, s:gui_red, s:cterm_dark_gray, s:cterm_red, ''],
      \ 'airline_y': [s:gui_dark_gray, s:gui_red, s:cterm_dark_gray, s:cterm_red, ''],
      \ }
let g:airline#themes#bubblegumslu#palette.insert_paste = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_orange, ''],
      \ }

" Replace mode
let g:airline#themes#bubblegumslu#palette.replace = {
      ...
      \ }
let g:airline#themes#bubblegumslu#palette.replace_modified = copy(g:airline#themes#bubblegumslu#palette.normal_modified)
...
let g:airline#themes#bubblegumslu#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#bubblegumslu#palette.visual_modified = copy(g:airline#themes#bubblegumslu#palette.normal_modified)

" Inactive window
let s:IA = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_dark_gray, '']
let g:airline#themes#bubblegumslu#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
let g:airline#themes#bubblegumslu#palette.inactive_modified = {
      \ 'airline_c': [s:gui_dark_gray, s:gui_red, s:cterm_dark_gray, s:cterm_red, ''],
      \ }

" tabline
let g:airline#themes#bubblegumslu#palette.tabline = {
      \ 'airline_tabtype':  [s:gui_med_gray_hi, s:gui_pink, s:cterm_med_gray_hi, '', ''],
...
let g:airline#themes#bubblegumslu#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
